...
const TRIAL_TRAFFIC_LIMIT_MB = parseInt(
  process.env.TRIAL_TRAFFIC_LIMIT_MB || "100",
  10
);
const TRIAL_TRAFFIC_LIMIT_BYTES = TRIAL_TRAFFIC_LIMIT_MB * 1024 * 1024; // Конвертация MB в байты
const TRIAL_TRAFFIC_WARNING_PERCENT = parseInt(
  process.env.TRIAL_TRAFFIC_WARNING_PERCENT || "80",
  10
...
export const config = {
  ...
  TRIAL_PERIOD_HOURS,
  TRIAL_TRAFFIC_LIMIT_MB,
  TRIAL_TRAFFIC_LIMIT_BYTES,
  TRIAL_TRAFFIC_WARNING_PERCENT,
